...
$RunnerLog = Join-Path $LogDir "layer2_k3_margin_runner.log"
$RunLog = Join-Path $LogDir "k3_margin_200e.log"
$Config = "configs\pa_csi_dg_subcenter_proto_layer2_200e_k3_margin_e2.json"
$Experiment = "pa_csi_dg_subcenter_proto_layer2_200e_k3_margin_e2"
...
try {
    Write-RunnerLog "Layer 2 K3 margin runner started. Force=${Force}"
